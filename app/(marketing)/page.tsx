...
export default function IndexPage() {
  ...
  return (
    <MarketingPageShell containerClassName="pt-4 pb-16 md:pt-6 md:pb-20">
      <WappkitApiNotice />
...
function WappkitApiNotice() {
  return (
    <section className="mb-6 overflow-hidden rounded-[1.35rem] border border-orange-200 bg-[linear-gradient(120deg,rgba(255,247,237,0.98),rgba(255,255,255,0.99))] p-4 shadow-[0_18px_50px_-34px_rgba(194,65,12,0.65)] md:px-5">
